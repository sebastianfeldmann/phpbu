...
class VersionTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $version = Version::id();
        $this->assertTrue(strpos($version, '1.1') !== false, 'version should match');

        $cachedVersion = Version::id();
        $this->assertTrue(strpos($cachedVersion, '1.1') !== false, 'version should match');
    }
    ...
    public function testGetVersion()
    {
        ...
        $this->assertEquals('phpbu 1.1', substr($version, 0, 9), 'version should match');
    }
